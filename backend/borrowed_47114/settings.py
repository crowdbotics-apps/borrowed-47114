"""
Django settings for borrowed_47114 project.
...
ROOT_URLCONF = 'borrowed_47114.urls'
...
WSGI_APPLICATION = 'borrowed_47114.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "borrowed_47114 API",
    "DESCRIPTION": "API documentation for borrowed_47114 App",
    "VERSION": "v1",
}
